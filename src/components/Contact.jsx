...
export default function Contact() {
  return (
    <section id='contact' className='section'>
      <div className="container mx-auto px-4 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-stretch">
          {/* Left Section */}
          ...
          {/* Right Section */}
          <form
            action="https://getform.io/f/bdrrvjob"
            method="POST"
            ...
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-4">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  placeholder="deepbhatt8866@gmail.com"
              ...
              <div className="mb-4 col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Hi!"
                  required
                  className="text-field resize-y min-h-32 max-h-80 reveal-up w-full"
                ></textarea>
              </div>
